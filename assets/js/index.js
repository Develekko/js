...
function q7()
{
  ...
  else if(valueInput*0 == 0)
  {
    document.getElementById("result7").innerHTML = "please Enter Character not Number!";
    document.getElementById("result7").classList.add("text-danger");
  }
  else if(EnglishLower.indexOf(valueInput) == -1 &&  EnglishUpper.indexOf(valueInput)== -1)
  {
    document.getElementById("result7").innerHTML = "please Enter English Character ";
    document.getElementById("result7").classList.add("text-danger");
  }
  else
  {
    if(valueInput == "a" || valueInput == "A" || valueInput == "e" || valueInput == "E" || valueInput == "i" || valueInput == "I" || valueInput == "o" || valueInput == "O" || valueInput == "u" || valueInput == "U")
    {
      ...
      document.getElementById("result7").classList.remove("text-danger");
    }
    else
    {
...
function q13()
{
  ...
  {
    document.getElementById("result13").innerHTML = CheckValue + " is not a number of month , Do u mean "+ Math.trunc(CheckValue) + " !"; 
    document.getElementById("result13").classList.add("text-danger");
  }
  else
  {
...
function q14()
{
  ...
  if(valueInput1 == "" && valueInput2 == "" && valueInput3 == "" && valueInput4 == "" && valueInput5 == "")
  {
    document.getElementById("result14-1").innerHTML = null;
    document.getElementById("result14-2").innerHTML = null;
  }
  else
  {
    if( percentage > 100)
    ...
    else if ( percentage < 0)
    {
      ...
      document.getElementById("result14-1").classList.remove("text-success");
      document.getElementById("result14-1").classList.add("text-danger");
    }
    else
    {
      document.getElementById("result14-1").innerHTML = percentage + " %"; 
      document.getElementById("result14-1").classList.add("text-success");
      document.getElementById("result14-1").classList.remove("text-danger");
    }
      ...
      else if( percentage < 40 && percentage >= 0)
      {
        ...
        document.getElementById("result14-1").classList.remove("text-success");
        document.getElementById("result14-1").style.color="red";
        document.getElementById("result14-2").classList.remove("text-success");
        document.getElementById("result14-2").style.color="red";
      }
      else
      {
        document.getElementById("result14-2").innerHTML = "There's no Grade in minus But u Still Got F"; 
        document.getElementById("result14-2").classList.remove("text-success");
        document.getElementById("result14-2").style.color="red";
      }
  }
